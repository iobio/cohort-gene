...
// Static functions
MultiSampleModel._summarizeDanger = function(geneName, theVcfData, options = {}, geneCoverageAll, filterModel, translator, annotationScheme) {
  var dangerCounts = $().extend({}, options);
  dangerCounts.geneName = geneName;
  MultiSampleModel.summarizeDangerForGeneCoverage(dangerCounts, geneCoverageAll, filterModel);
...
MultiSampleModel.summarizeDangerForGeneCoverage = function(dangerObject, geneCoverageAll, filterModel, clearOtherDanger=false, refreshOnly=false ) {
