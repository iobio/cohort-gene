...
class DataSetModel {
  constructor(parentCore) {
    ...
    // TODO: not sure if any of these still need to moved to CoreModel

    // TODO: do I need a gene list in here?

    this.core = parentCore;
  }

  // TODO: when and where was cohortModel composed (old)?
  ...
  initDemo() {
    let self = this;
    var demoBams = [];
    var demoVcf = 'https://s3.amazonaws.com/iobio/samples/vcf/platinum-exome.vcf.gz';
    var demoModel = new CohortModel(self, demoVcf, demoBams); // TODO: how do you pass a reference to this correctly
    self.cohorts.push(demoModel);
    self.cohortMap.push({'demo': demoModel});
    self.promiseInit();
  }

  initData() {
    // TODO: take in vcf and bam params, assign them, and then call promiseInit
  }
