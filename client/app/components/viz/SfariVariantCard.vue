...
<template>
  <v-card tile id="sfari-variant-card" class="app-card">
    <v-card-title>SFARI VARIANTS
      <div style="width:100%">
        <div style="text-align: center;clear: both;">

          <!-- SJG TODO: I may need another loading section below for subset track -->

          <div class="loader vcfloader" v-bind:class="{ hide: !sfariModel.allInProgress.loadingVariants }" style="display: inline-block;">
            <span class="loader-label">Annotating variants</span>
            <img src="../../../assets/images/wheel.gif">
          </div>
          <div class="loader fbloader" v-bind:class="{ hide: !sfariModel.allInProgress.callingVariants }" style="display: inline-block;padding-left: 20px;">
            <span class="loader-label">Calling variants</span>
            <img src="../../../assets/images/wheel.gif">
          </div>
          <div class="loader covloader" v-bind:class="{ hide: !sfariModel.allInProgress.loadingCoverage }"style="display: inline-block;padding-left: 20px;">
