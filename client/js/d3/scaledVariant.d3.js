function scaledVariantD3() {
     ...
     * Returns the number of variants that pass the applied filters. */
                    ...
                    switch(filterLogic) {
                        case '<':
                            if (filterName === 'probandFreq') {
                                ...
                                let totalAlleleCount = (2 * d.probandZygCounts[0]) + (2 * d.probandZygCounts[1]) + (2 * d.probandZygCounts[2]);
                                ...
                                let totalAlleleCount = (2 * d.subsetZygCounts[0]) + (2 * d.subsetZygCounts[1]) + (2 * d.subsetZygCounts[2]);
                                varVal = Math.round(numMutantAlleles / totalAlleleCount * 100);
